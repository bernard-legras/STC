...
# %% Tile 1shifted impact low levels (shifted for key figure)
fname1 = join(forw_dir,'target-norm','chart-EAD-Box-theta-FullAMA-target-norm-350K-All-h1728-sh.png')
fname3 = join(forw_dir,'target-norm','chart-EAD-Box-theta-FullAMA-target-norm-360K-All-h1728-sh.png')
fname5 = join(forw_dir,'target-norm','chart-EAD-Box-theta-FullAMA-target-norm-370K-All-h1728-sh.png')
fname7 = join(forw_dir,'target-norm','chart-EAD-Box-theta-FullAMA-target-norm-380K-All-h1728-sh.png')
...
draw.text((w,2*h),u'(f)',fill='blue',font=font)
draw.text((w,3*h),u'(h)',fill='blue',font=font)
draw.text((300,150),u'target 350 K',fill='yellow',font=font)
draw.text((300,h+150),u'target 360 K',fill='yellow',font=font)
draw.text((300,2*h+150),u'target 370 K',fill='yellow',font=font)
draw.text((300,3*h+150),u'target 380 K',fill='yellow',font=font)
draw.text((w+300,150),u'source 350 K',fill='yellow',font=font)
draw.text((w+300,h+150),u'source 360 K',fill='yellow',font=font)
draw.text((w+300,2*h+150),u'source 370 K',fill='yellow',font=font)
draw.text((w+300,3*h+150),u'source 380 K',fill='yellow',font=font)
bb.save('figs-Box/tile1shift.png',dpi=(300,300))
#bb.show()
