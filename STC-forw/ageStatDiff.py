...
# -*- coding: utf-8 -*-
"""
This version of the script differs from ageStat by selecting only the parcels
launched between 349 K and 350 K in order to determine the diffusion through impulse response 
at 349.5 K which is the maximum of the source spectrum.
...
file_out = join(out_dir,'ageStatDiff-'+supertype+'-'+str(year)+'-'+date)

print("ageStatDiff> process "+supertype+' '+date)
...
# filtering to get impulse response
live[(thet>350) | (thet<349)] = False
