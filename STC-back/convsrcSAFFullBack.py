...
It does not filter out the spurious contribution from high-latitude clouds. This has to
be done afterwards but it would be better to do it here as such trajectories are lost for 
cloud encounter.
...
def main():
    ...
    out_dir = os.path.join(out_dir,'STC-BACK-OUT-SAF-'+cloud_type)
